...
**1. NATURE** — A framework for community collaboration, not a revenue contract. Each activity is confirmed by a simple written order. A written order is a confirmation of an activity (email suffices) stating its date, scope and approved brand use.
