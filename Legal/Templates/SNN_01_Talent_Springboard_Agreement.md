# SNN_01 — SNN TALENT SPRINGBOARD AGREEMENT (ROSTER)

**THIS AGREEMENT** is made on [date]

**BETWEEN:** (1) **SHACK ENTERTAINMENT LIMITED**, company no. 14628241, of 25 Fielding Avenue, Twickenham, England, TW2 5LX, trading as Shack News Network (SNN), publisher of Shack Daily News ("the Company"); and (2) **[TALENT NAME]**, of [address] ("the Talent"), SNN ID [SNN-xxx].
...
**10. GENERAL**
10.1 Clauses 9.1-9.9 of AU_01 apply as if repeated here.
